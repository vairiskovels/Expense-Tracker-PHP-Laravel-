    ...
    <main id="dashboard-page" class="main">
        <section id="dashboard-text">
            ...
            <div class="canvas pie">
                ...
                <p class="small-text">*This month</p>
        ...
        <section id="dashboard-cards">
            <div class="categories-wrap">
                ...
                <div class="row">
                    ...
                    <div class="category-card" id="{{$category->name}}-card" @if ($category->price !== NULL)onclick="location.href='/category/{{strtolower($category->name)}}';"@endif>
